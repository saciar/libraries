...
public class OrdenServicioSala {
	private long salaId;
	...
	private OrdenServicioServicio[] servicios;
	...
	public OrdenServicioServicio[] getServicios() {
		return servicios;
	}

	public void setServicios(OrdenServicioServicio[] servicios) {
