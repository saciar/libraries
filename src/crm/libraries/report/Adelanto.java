...
public class Adelanto {
	...
	/**
	 * @return Returns the codProvCrn.
	 */
	public String getCodProvCrn() {
		return codProvCrn;
	}
	/**
	 * @param codProvCrn The codProvCrn to set.
	 */
	public void setCodProvCrn(String codProvCrn) {
		this.codProvCrn = codProvCrn;
	}
	/**
	 * @return Returns the condicionPago.
	 */
	...
	/**
	 * @return Returns the condIva.
	 */
	public String getCondIva() {
		return condIva;
	}
	/**
	 * @param condIva The condIva to set.
	 */
	public void setCondIva(String condIva) {
		this.condIva = condIva;
	}
	/**
	 * @return Returns the contactoCliente.
	 */
	public String getContactoCliente() {
		return contactoCliente;
	}
	/**
	 * @param contactoCliente The contactoCliente to set.
	 */
	public void setContactoCliente(String contactoCliente) {
		this.contactoCliente = contactoCliente;
	}
	/**
	 * @return Returns the cuit.
	 */
	...
	/**
	 * @param fechaFinalEvento The fechaFinalEvento to set.
	 */
	...
	/**
	 * @param fechaInicialEvento The fechaInicialEvento to set.
	 */
	...
	/**
	 * @return Returns the ordenFacturacion.
	 */
	public long getOrdenFacturacion() {
		return ordenFacturacion;
	}
	/**
	 * @param ordenFacturacion The ordenFacturacion to set.
	 */
