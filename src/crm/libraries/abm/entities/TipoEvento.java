...
public class TipoEvento implements ABMEntity{
	
	public TipoEvento() {
		codigo = "0";
	}

	public TipoEvento(String cod, String desc,String act) {        
        codigo = cod;
        descripcion = desc;
        activo = act;
    }
    ...
    public String getProtocolListString() {
    	...
    	return s.substring(new String("TipoEvento:").length()-1, s.length());
