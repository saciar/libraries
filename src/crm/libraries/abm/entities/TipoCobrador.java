...
public class TipoCobrador implements ABMEntity{

	public TipoCobrador() {
		codigo = "0";
	}

	public TipoCobrador(String cod, String desc,String act) {        
        codigo = cod;
        descripcion = desc;
        activo = act;
    }
    ...
    public String getProtocolListString() {
    	...
    	return s.substring(new String("TipoCobrador:").length()-1, s.length());
